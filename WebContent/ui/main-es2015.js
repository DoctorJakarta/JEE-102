...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony default export */ __webpack_exports__["default"] = ("<p>jee103 works!</p>\n");
...
let Jee101Component = class Jee101Component {
    ...
    getGreeting() {
        this._apiService.readGreeting().subscribe(success => {
...
let Jee102Component = class Jee102Component {
    ...
    getBooks() {
        this.apiService.readBooks().subscribe(success => {
            this.books = success;
    ...
    showEdit(id) {
        ...
        this.apiService.readBook(id).subscribe(success => {
            this.book = success;
        }, error => this.apiService.handleError(error));
    }
    upsertBook() {
    ...
    deleteBook(id) {
        if (confirm('Are you sure you want to delete the book?')) {
            this.apiService.deleteBook(id).subscribe(success => {
                this.getBooks();
            }, error => this.apiService.handleError(error));
        }
    }
...
let service102;
let service103;
const myHeaders = new _angular_common_http__WEBPACK_IMPORTED_MODULE_1__["HttpHeaders"]()
...
let ApiService = class ApiService {
    ...
    //
    readGreeting() {
        return this.http.get(service101 + 'hello', { observe: 'response', headers: this.jeeHeaders(this.getJwtAccess()) });
    }
    //
    ...
    createBook(book) {
        return this.http.post(service102 + 'book', JSON.stringify(book), { headers: myHeaders });
    }
    updateBook(book) {
        return this.http.put(service102 + 'book', JSON.stringify(book), { headers: myHeaders });
    }
    deleteBook(id) {
        return this.http.delete(service102 + 'book/' + id, { headers: myHeaders });
    }
};
